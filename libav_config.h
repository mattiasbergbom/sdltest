...
#define LIBAV_CONFIGURATION "--cross-prefix=pnacl- --arch=pnacl --target-os=linux --enable-gpl --enable-nonfree --enable-static --enable-cross-compile --disable-asm --disable-inline-asm --disable-programs --disable-ssse3 --disable-mmx --disable-mmxext --disable-amd3dnow --disable-amd3dnowext --disable-indevs --disable-protocols --disable-network --disable-zlib --prefix=/naclports-dummydir --disable-everything --enable-rdft --enable-fft --enable-hwaccel=dxva2 --enable-hwaccel=vdpau --enable-demuxer=mpegts --enable-demuxer=mov --enable-demuxer=h264 --enable-demuxer=aac --enable-decoder=aac --enable-decoder=h264 --enable-parser=h264 --enable-parser=mpeg4video --enable-parser=mpegvideo --enable-parser=aac --enable-parser=aac_latm --enable-protocol=hls --enable-protocol=rtmp --enable-protocol=tcp --enable-protocol=udp --enable-protocol=file --enable-filter=format --cc=pnacl-clang"
#define LIBAV_LICENSE "nonfree and unredistributable"
#define AVCONV_DATADIR "/naclports-dummydir/share/avconv"
#define CC_IDENT "clang version 3.5.0 (https://chromium.googlesource.com/a/native_client/pnacl-clang.git f91749d7ec7e80890d603685114b4e9c3d0ce3dc) (https://chromium.googlesource.com/a/native_client/pnacl-llvm.git 03e70587abbb52791c483e07a99917a67af35036) nacl-version=db7f23a6d9fd2d1673de75dd464930c080f88987"
